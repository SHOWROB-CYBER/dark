...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+8801739237334?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/SHOWROB-404/dark.git')
                main()
        elif menu_opt =='4':
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/SHOWROB' in datar:
        pass
else:
        for i in range(5000):
